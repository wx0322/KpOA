...
export class DailyWorkServiceProxy {
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<DailyWorkDto> {
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, isPublished: boolean | null | undefined, userName: string | null | undefined, userId: number | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<DailyWorkDtoPagedResultDto> {
     ...
     * @return Success
     */
    update(body: DailyWorkDto | undefined): Observable<DailyWorkDto> {
