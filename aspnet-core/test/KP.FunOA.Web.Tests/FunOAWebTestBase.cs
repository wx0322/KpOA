...
{
    public abstract class FunOAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FunOAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FunOAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FunOADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FunOADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FunOADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FunOADbContext, Task<T>> func)
        {
            T result;
